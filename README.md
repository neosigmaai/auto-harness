...
> **Take-home test environment:** this branch pins a 12-task Terminal-Bench
> subset for the Agent Optimization Service assignment. See **[TAKEHOME.md](TAKEHOME.md)**
> for the task list, rationale, and how to promote an improved `agent/agent.py`
> back into this repo.
